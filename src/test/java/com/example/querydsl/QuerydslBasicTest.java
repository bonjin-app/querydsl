...
import com.example.querydsl.entity.dto.UserDto;
...
//                .fetchResults();
     ...
     * 1. 회원 나이 내림차순(desc)
     * 2. 회원 이름 올림차순(asc)
     * 단 2개에서 회원 이름이 없으면 마지막에 출력(nulls last)
     */
    @Test
    public void sert() {
    ...
    public void findDtoByJPQL() {
        List<MemberDto> result = em.createQuery("select new com.example.querydsl.entity.dto.MemberDto(m.username, m.age) from Member m", MemberDto.class)
                .getResultList();
...
//                .where(usernameEq(usernameCond), ageEq(ageCond))
    ...
    /**
     * SQL function은 JPA와 같이 Dialect에 등록된 함수만 호출
     */
    @Test
